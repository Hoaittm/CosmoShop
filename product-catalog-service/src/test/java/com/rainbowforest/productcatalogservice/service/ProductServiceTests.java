...
public class ProductServiceTests {
    ...
    public void get_all_products_by_name_test() {
        // Data preparation
        Mockito.when(productRepository.findByProductNameContainingIgnoreCase(PRODUCT_NAME)).thenReturn(products);
        ...
        Mockito.verify(productRepository, Mockito.times(1)).findByProductNameContainingIgnoreCase(Mockito.anyString());
        Mockito.verifyNoMoreInteractions(productRepository);
    }
